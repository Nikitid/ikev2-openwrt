...
var ru = {
	...
	'Suppress broken HTTPS DNS records for this segment so browsers can fall back to A and AAAA. Applies in Reliable mode.': 'Подавляет некорректные DNS-записи HTTPS для этого сегмента, чтобы браузеры могли использовать A и AAAA. Действует в надёжном режиме.',
