...
var ru = {
	...
	'Domains': 'Домены','IP networks': 'IP-сети','Policy': 'Политика',
	'Active': 'Активна','Rebuilding': 'Пересобирается','Failed': 'Сбой',
	'Selected on this page': 'Выбрано на этой странице','Routed through the tunnel': 'Направляются через туннель',
	'From selected services': 'Из выбранных сервисов','Including your own: ': 'В том числе ваших: ','Updated: ': 'Обновлено: ',
	'Pause tunnel routing': 'Приостановить маршрутизацию','Resume tunnel routing': 'Возобновить маршрутизацию',
	'Paused': 'На паузе','Routing': 'Маршрутизирует',
